describe('Alert Ejection', () => {
    ...
    Cypress.on('uncaught:exception', (err, runnable) => {
      ...
      it ('Alert Ejection', function () {
        ...
        cy.wait(2000)
        cy.get('input[id$="--AlertName-inner"]').eq(0).type("Ejection Alert Test" , {force: true})
        ...
        cy.get('input[id^="__input0-__list9"]').eq(4).type("N" , {force: true})
