describe('Alert Ejection', () => {
    ...
    Cypress.on('uncaught:exception', (err, runnable) => {
      ...
      it ('Alert Ejection', function () {
        ...
        cy.wait(2000)
        cy.get('input[id$="--AlertName-inner"]').eq(0).type("Ejection Alert Test 6" , {force: true})
        ...
        cy.get('input[id^="__input0-__list9"]').eq(1).type("20" , {force: true})
        cy.get('input[id^="__input0-__list9"]').eq(2).type("C" , {force: true})
        ...
        cy.get('#__list6>li').each(($e,index)=>{
            if ($e.text() === "Ejection Alert Test 6") {
               cy.wrap($e).click({force: true})}
               }) 
        ...
        cy.get('input[id$="--inputDeltaID-inner"]').eq(0).type("78" , {force: true})
        ...
        cy.get('input[id$="--inputDeltaID-inner"]').eq(0).type("10" , {force: true})
        cy.get('span[id$="--adjustOKButton-content"]').eq(0).click({force: true})
        ...
        cy.get('span[id$="--reportProductionQuantityTable-1-content"]').eq(0).click({force: true})
        cy.get('input[id$="--inputDeltaID-inner"]').eq(0).type("2" , {force: true})
        cy.get('span[id$="--adjustOKButton-content"]').eq(0).click({force: true})
        ...
        cy.wait(2000)
        cy.get('span[id$="__clone0-titleText-inner"]').eq(0).click({force: true}) 
        cy.wait(2000)
        cy.get('span[id$="--reportProductionQuantityTable-0-content"]').eq(0).click({force: true})
        cy.get('input[id$="--inputDeltaID-inner"]').eq(0).type("99" , {force: true})
        cy.get('span[id$="--adjustOKButton-content"]').eq(0).click({force: true})
        cy.get('span[id$="--reportProductionQuantityTable-1-content"]').eq(0).click({force: true})
